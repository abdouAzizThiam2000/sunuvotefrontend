    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled CTAs">
                <li><a href="inscription.php" class="article">SE DECONNECTER &nbsp;<i class='fas fa-external-link-square-alt'></i>
                    </a></li>
            </ul>
        </nav>
                    ...
                    <form name="style.php" method="post">
                        ...
                        <div class="form-check-inline">
                            <label class="form-check-label" for="radio1">
                                <input type="radio" class="form-check-input" id="radio1" name="optradio" value="option1" checked>OUSMANE SONKO
                            </label>
                        </div>
                        <div class="form-check-inline">
                            <label class="form-check-label" for="radio2">
                                <input type="radio" class="form-check-input" id="radio2" name="optradio" value="option2">IDY IDRISSA
                            </label>
                        </div>

                        <div class="form-check-inline">
                            <label class="form-check-label" for="radio2">
                                <input type="radio" class="form-check-input" id="radio2" name="optradio" value="option3">MACKY SALL
                            </label>
                        </div>
                        <br>
                        <div class="text-center">
                            <button class="btn btn-outline-info" type="submit" name="valider" value="OK"> <i class='fa fa-check'></i>
